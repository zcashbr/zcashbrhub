...
export const categoriasDeLinks = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Trocar $Sol por $Zec na Solswap " , description: "Breve tutorial de como trocar por solana por zcash na SolSwap." , url: "https://youtu.be/YEccCDMsOa0?si=kYIDQLZEaxN_31C9"  },
    ]
  },
  {
